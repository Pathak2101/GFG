<h2><a href="https://practice.geeksforgeeks.org/problems/three-way-partitioning/1?page=1&sprint=94ade6723438d94ecf0c00c3937dad55&sortBy=submissions">Three way partitioning</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array of size n&nbsp;and a range [<strong>a</strong>, <strong>b</strong>]. The task is to partition the array around the range such that array is divided into three parts.<br>
