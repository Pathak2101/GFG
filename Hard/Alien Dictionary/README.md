<h2><a href="https://practice.geeksforgeeks.org/problems/alien-dictionary/1?page=1&difficulty[]=0&difficulty[]=1&difficulty[]=2&category[]=Strings&curated[]=7&sortBy=submissions">Alien Dictionary</a></h2><h3>Difficulty Level : Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a sorted dictionary of an alien language having N words and&nbsp;k starting alphabets of standard dictionary. Find the order of characters in the alien language.<br>
